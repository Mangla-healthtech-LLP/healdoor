  ...
  return (
    <>
      ...
      <main className="flex-1">
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col justify-center">
                ...
                {product.category && (
                  <span className="inline-block px-4 py-1.5 bg-teal-light text-teal text-sm font-bold rounded-full w-fit mb-8 uppercase tracking-wider">
                ...
                {(product.rentPrice || product.buyPrice) && (
                  <div className="mb-8 flex flex-wrap gap-6 sm:gap-10 items-center p-5 bg-section-alt-bg rounded-xl border border-border/50 shadow-sm">
                ...
                <div className="mb-6 space-y-3">
                  <Link 
                    ...
                    className="flex w-full justify-center items-center gap-2 px-6 py-3.5 bg-teal hover:bg-teal-dark text-white rounded-xl font-bold text-base transition-colors shadow-md shadow-teal/20"
                  >
                ...
                <div className="space-y-4">
                  {product.features && product.features.length > 0 && (
                    <div>
                      <h3 className="text-lg font-bold text-text-dark mb-4">Key Features</h3>
                      ...
                      {product.features.length > 4 && (
                        <a href="#details" className="text-teal hover:text-teal-dark font-medium mt-4 inline-block text-sm">
        ...
        <section id="details" className="py-10 lg:py-16 bg-section-alt-bg border-t border-border/50">
          <div className="container max-w-5xl">
            {product.description && (
              <div className="mb-8 bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-border/50">
                <h2 className="font-heading text-2xl font-bold text-text-dark mb-6">Description</h2>
            ...
            {product.features && product.features.length > 0 && (
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-border/50">
                <h2 className="font-heading text-2xl font-bold text-text-dark mb-6">Technical Specifications</h2>
                <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4">
                  {product.features.map((feature, idx) => (
                    <div key={idx} className="flex gap-3 py-3 border-b border-border/50 last:border-0 sm:last:border-b sm:[&:nth-last-child(2)]:border-0">
                      <CheckCircle2 className="w-5 h-5 text-teal shrink-0 mt-0.5" />
        ...
        {formattedFaqs && formattedFaqs.length > 0 && (
          <div className="bg-white">
            <FAQBlock 
              blockType="faq"
              sectionTitle={`Frequently Asked Questions about ${product.name}`}
